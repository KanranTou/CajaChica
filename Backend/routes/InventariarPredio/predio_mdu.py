...
from schemas.predio_mdu_schema import predioMdu_schema, prediosMdus_schema
...
predio_mdu= Blueprint('predio_mdu',__name__)


data_Mdu = []

@predio_mdu.route('/new/predio_mdu', methods=['POST', 'GET'])
def add_predio_mdu():
...
@predio_mdu.route('/update/predio_mdu/<id>', methods = ['POST','GET'])
...
@predio_mdu.route('/delete/predio_mdu/<id>')
