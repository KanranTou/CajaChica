...
export class ConexionService {
  ...
  crearCajaChica(data: any): Observable<any> {
    return this.http.post(`${this.BASE_URL}/cajachica/crear`, data);
  }

  // Método para obtener todas las cajas chicas
  obtenerTodasCajasChicas(): Observable<any> {
    return this.http.get(`${this.BASE_URL}/cajachica/obtener`);
  }

  // Método para obtener una caja chica por su ID
  obtenerCajaChicaPorId(idCajaChica: number): Observable<any> {
    return this.http.get(`${this.BASE_URL}/cajachica/formulario/${idCajaChica}`);
  }
